 ...
 *
 * <p>Rewrite from 2020. Optimized variant taking two steps into each direction (the original
 * implementation contained the same optimization). This optimization is possible as cat and mouse
 * can change their direction only on every two steps (on coordinates with even x and y values).
 *
 * @author <a href="sven@happycoders.eu">Sven Woltmann</a>
 */
public class CatAlgorithmFrom2020Opt implements CatAlgorithm {
